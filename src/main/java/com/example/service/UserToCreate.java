...
public class UserToCreate {
    ...
    public SqlUser buildUserToRepository(UserReq userReq) {
        ...
        SqlUser userToRepo = SqlUser.builder()
                ...
                .age(userDataFromWeb.getAge(userReq.getFirstName()))
                .gender(userDataFromWeb.getGender(userReq.getFirstName()))
                .nationality(userDataFromWeb.getNationCode(userReq.getFirstName()))
